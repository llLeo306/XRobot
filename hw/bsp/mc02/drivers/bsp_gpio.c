...
static const bsp_gpio_map_t bsp_gpio_map[BSP_GPIO_NUM] = {
    ...
    {PUMP_E_Pin, PUMP_E_GPIO_Port},
    {PUMP_0_Pin, PUMP_0_GPIO_Port},
    {PUMP_1_Pin, PUMP_1_GPIO_Port},
    {PUMP_1_B_Pin, PUMP_1_B_GPIO_Port},
    {PRESSURE_SENSOR_Pin, PRESSURE_SENSOR_GPIO_Port},
