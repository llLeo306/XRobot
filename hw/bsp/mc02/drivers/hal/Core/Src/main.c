...
#include "stm32h7xx_hal_timebase_tim.c"
...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.NominalPrescaler = 22;
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.NominalPrescaler = 22;
...
void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.NominalPrescaler = 22;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, POWER_24V_2_Pin|POWER_5V_Pin|ACCL_CS_Pin|GYRO_CS_Pin
                          |DCMI_PWDN_Pin|PUMP_1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_14|PUMP_1_B_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PUMP_E_Pin|PUMP_0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : POWER_24V_2_Pin PC14 POWER_5V_Pin PUMP_1_Pin
                           PUMP_1_B_Pin */
  GPIO_InitStruct.Pin = POWER_24V_2_Pin|GPIO_PIN_14|POWER_5V_Pin|PUMP_1_Pin
                          |PUMP_1_B_Pin;
  ...
  /*Configure GPIO pin : PRESSURE_SENSOR_Pin */
  ...
  /*Configure GPIO pins : PUMP_E_Pin PUMP_0_Pin */
  GPIO_InitStruct.Pin = PUMP_E_Pin|PUMP_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
